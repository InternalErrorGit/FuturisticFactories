...
public class CrystallizingTileEntity extends MachineTileEntity<PressingRecipe> {
    public <T extends MachineTileEntity<?>> CrystallizingTileEntity(int inventorySize, TileEntityType<T> tileEntityType) {
