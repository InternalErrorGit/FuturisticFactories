...
public class FFLanguageProvider extends LanguageProvider implements IFFRegistryNames {
    ...
    protected void addTranslations() {
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_CHUNK.get(), REGISTRY_NAME_GOLD_ORE_CHUNK);
        addEN_US(FFItemRegistry.IRON_ORE_CHUNK.get(), REGISTRY_NAME_IRON_ORE_CHUNK);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_CLUMP.get(), REGISTRY_NAME_GOLD_ORE_CLUMP);
        addEN_US(FFItemRegistry.IRON_ORE_CLUMP.get(), REGISTRY_NAME_IRON_ORE_CLUMP);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_CRYSTAL.get(), REGISTRY_NAME_GOLD_ORE_CRYSTAL);
        addEN_US(FFItemRegistry.IRON_ORE_CRYSTAL.get(), REGISTRY_NAME_IRON_ORE_CRYSTAL);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_TINY_CRYSTAL.get(), REGISTRY_NAME_GOLD_ORE_TINY_CRYSTAL);
        addEN_US(FFItemRegistry.IRON_ORE_TINY_CRYSTAL.get(), REGISTRY_NAME_IRON_ORE_TINY_CRYSTAL);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_DUST.get(), REGISTRY_NAME_GOLD_ORE_DUST);
        addEN_US(FFItemRegistry.IRON_ORE_DUST.get(), REGISTRY_NAME_IRON_ORE_DUST);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_DIRTY_DUST.get(), REGISTRY_NAME_GOLD_ORE_DIRTY_DUST);
        addEN_US(FFItemRegistry.IRON_ORE_DIRTY_DUST.get(), REGISTRY_NAME_IRON_ORE_DIRTY_DUST);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_FRAGMENT.get(), REGISTRY_NAME_GOLD_ORE_FRAGMENT);
        addEN_US(FFItemRegistry.IRON_ORE_FRAGMENT.get(), REGISTRY_NAME_IRON_ORE_FRAGMENT);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_PIECE.get(), REGISTRY_NAME_GOLD_ORE_PIECE);
        addEN_US(FFItemRegistry.IRON_ORE_PIECE.get(), REGISTRY_NAME_IRON_ORE_PIECE);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_PILE.get(), REGISTRY_NAME_GOLD_ORE_PILE);
        addEN_US(FFItemRegistry.IRON_ORE_PILE.get(), REGISTRY_NAME_IRON_ORE_PILE);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_RESIDUAL.get(), REGISTRY_NAME_GOLD_ORE_RESIDUAL);
        addEN_US(FFItemRegistry.IRON_ORE_RESIDUAL.get(), REGISTRY_NAME_IRON_ORE_RESIDUAL);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_SAND.get(), REGISTRY_NAME_GOLD_ORE_SAND);
        addEN_US(FFItemRegistry.IRON_ORE_SAND.get(), REGISTRY_NAME_IRON_ORE_SAND);
        ...
        addEN_US(FFItemRegistry.GOLD_ORE_SHARD.get(), REGISTRY_NAME_GOLD_ORE_SHARD);
        addEN_US(FFItemRegistry.IRON_ORE_SHARD.get(), REGISTRY_NAME_IRON_ORE_SHARD);
