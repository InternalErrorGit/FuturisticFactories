...
public interface IFFRegistry<T extends IForgeRegistryEntry<T>> {
    ...
    String BLOCK_ORE_ALUMINUM = "block_ore_aluminum";
    ...
    String BLOCK_ALUMINUM = "block_aluminum";
    ...
    String BLOCK_MACHINE_SMELTER = "block_machine_smelter";

    String ITEM_BLOCK_ORE_COPPER = "item_block_ore_copper";
    String ITEM_BLOCK_ORE_ALUMINUM = "item_block_ore_aluminum";
    ...
    String ITEM_BLOCK_ALUMINUM = "item_block_aluminum";
    ...
    String ITEM_BLOCK_MACHINE_SMELTER = "block_machine_smelter";


    String ITEM_NUGGET_ALUMINUM = "item_nugget_aluminum";
    ...
    String ITEM_INGOT_ALUMINUM = "item_ingot_aluminum";
